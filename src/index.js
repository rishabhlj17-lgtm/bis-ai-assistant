...
async function askGemini(question, sources, apiKey) {
  ...
  for (const model of models) {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        failures.push(model + " (" + response.status + "): " + apiMessage);
        continue;
      }
  ...
  throw new Error(
    "Gemini AI could not complete the request. " + failures.join(" | ")
  );
}

function htmlPage(mode = "home") {
      ...
      <div class="assistant-layout">
        ...
        <section class="assistant-card">
          ...
          <div class="assistant-body">
            ...
            <button id="askButton" class="ask" onclick="ask()">Ask BIS AI Assistant</button>

            <div class="examples">
              Suggested questions:
              <span class="example" onclick="useExample('What is BIS product certification?')">What is BIS product certification?</span>
              <span class="example" onclick="useExample('How can a manufacturer apply for a BIS licence?')">How do I apply for a BIS licence?</span>
              <span class="example" onclick="useExample('How can I find the Indian Standard applicable to my product?')">Find my Indian Standard</span>
            </div>

            <div id="answer" class="answer">Your answer will appear here.</div>
            <div id="status" class="status"></div>
            <div id="sources" class="sources"></div>
            <div class="status">This independent prototype uses a curated BIS knowledge layer and Gemini AI. It is not an official BIS product or endorsement.</div>
          </div>
        </section>
      </div>
    `
    : String.raw`
      ...
      <div class="hero">
        ...
        <aside class="news">
          ...
          <div class="news-item">Explore latest BIS standards, certification and quality initiatives.</div>
      ...
      <div class="services">
        <a class="service" href="https://standards.bis.gov.in/" target="_blank" rel="noopener"><strong>Standardization</strong><span>Indian Standards, published standards, drafts and technical information.</span></a>
        <a class="service" href="https://www.bis.gov.in/product-certification/?lang=en" target="_blank" rel="noopener"><strong>Conformity Assessment</strong><span>Product certification, licensing and certification processes.</span></a>
        ...
        <a class="service" href="https://www.bis.gov.in/system-certification-overview/?lang=en" target="_blank" rel="noopener"><strong>System Certification</strong><span>Management system certification information and services.</span></a>
        <a class="service" href="https://www.bis.gov.in/laboratory-services/?lang=en" target="_blank" rel="noopener"><strong>Laboratory Services</strong><span>Laboratory-related conformity assessment information.</span></a>
        <a class="service" href="https://www.bis.gov.in/hallmarking/?lang=en" target="_blank" rel="noopener"><strong>Hallmarking</strong><span>Consumer and industry information related to hallmarking.</span></a>
        <a class="service" href="https://www.bis.gov.in/training-services/?lang=en" target="_blank" rel="noopener"><strong>Training</strong><span>Training and capacity-building programmes and resources.</span></a>
        <a class="service" href="/assistant"><strong>BIS AI Assistant</strong><span>Natural-language help for discovering and understanding BIS information.</span></a>
      </div>

      <h2 class="section-title">Important BIS Information</h2>
      <div class="services">
        <a class="service" href="https://www.bis.gov.in/know-your-standard/?lang=en" target="_blank" rel="noopener"><strong>Know Your Standard</strong><span>Search by Indian Standard number or product keyword.</span></a>
        <a class="service" href="https://www.bis.gov.in/apply-for-a-license/?lang=en" target="_blank" rel="noopener"><strong>Apply For Licence</strong><span>Steps and guidance for BIS product certification licensing.</span></a>
...
.brand-title{color:#123f6d;font-size:24px;font-weight:700;line-height:1.1}
.brand-subtitle{color:#555;font-size:12px;margin-top:5px}
...
.container{max-width:1240px;margin:0 auto;padding:24px 18px 42px}
.breadcrumb{font-size:12px;color:#777;margin-bottom:16px}
.hero{display:grid;grid-template-columns:2fr 1fr;gap:20px;margin-bottom:22px}
.hero-main{min-height:250px;padding:34px;background:linear-gradient(120deg,#0b4d86,#1168a5);color:#fff;position:relative;overflow:hidden}
.hero-main:after{content:"";position:absolute;width:260px;height:260px;border:35px solid rgba(236,183,35,.35);border-radius:50%;right:-100px;top:-95px}
.hero-main h1{margin:0 0 12px;font-size:34px;position:relative;z-index:1}.hero-main p{max-width:690px;line-height:1.65;position:relative;z-index:1}
.hero-btn{display:inline-block;margin-top:12px;background:#d39b19;padding:11px 16px;text-decoration:none;font-weight:700;position:relative;z-index:1}
.news{border:1px solid #d7d7d7;background:#fff}.news h3{margin:0;padding:12px 15px;background:#0b4d86;color:#fff;font-size:16px}
.news-item{padding:12px 14px;border-bottom:1px solid #e8e8e8;font-size:13px;line-height:1.45}
...
.service{min-height:108px;padding:17px;border:1px solid #d9dee5;background:#f7fafc;text-decoration:none}
.service strong{display:block;color:#0b4d86;font-size:15px;margin-bottom:7px}.service span{font-size:12px;color:#606b78;line-height:1.4}
.assistant-layout{display:grid;grid-template-columns:270px 1fr;gap:20px}
.sidebar{border:1px solid #d9dee5;background:#f6f8fa;height:max-content}.sidebar-title{background:#0b4d86;color:#fff;padding:13px 14px;font-size:15px;font-weight:700}
.sidebar a{display:block;padding:11px 13px;border-bottom:1px solid #e2e5e8;text-decoration:none;font-size:13px}.sidebar a:hover{background:#e9f0f6}
.assistant-card{border:1px solid #d0d8e0;box-shadow:0 2px 8px rgba(0,0,0,.08);background:#fff}
.assistant-head{padding:20px 22px;background:#f3f7fb;border-bottom:1px solid #d7e0e8}.assistant-head h1{margin:0;color:#0b4d86;font-size:28px}
.assistant-head p{margin:8px 0 0;color:#5f6975;line-height:1.55}.assistant-body{padding:22px}
textarea{width:100%;min-height:150px;border:1px solid #aeb9c5;padding:14px;font-size:15px;font-family:Arial,Helvetica,sans-serif;resize:vertical}
...
.footer{background:#123f6d;color:#fff;margin-top:30px}.footer-inner{max-width:1240px;margin:auto;padding:28px 18px;display:grid;grid-template-columns:2fr 1fr 1fr;gap:24px}
.footer h4{margin:0 0 9px;font-size:14px}.footer p,.footer a{font-size:12px;line-height:1.55;color:#e3ebf3}.footer a{text-decoration:none;display:block}
.disclaimer{background:#0c2f50;color:#dce8f3;padding:9px 18px;text-align:center;font-size:11px}
...
<body>
<div class="topbar"><div class="topbar-inner"><div class="gov">Government of India</div><div class="toplinks"><a href="https://www.bis.gov.in/" target="_blank" rel="noopener">Official BIS Website</a><a href="https://www.bis.gov.in/contact-us/?lang=en" target="_blank" rel="noopener">Contact Us</a><a href="#main">Skip to main content</a></div></div></div>
<header class="header">
...
<footer class="footer">
  <div class="footer-inner">
    ...
    <div><h4>Verification</h4><p>Always verify current requirements, standards, notices and regulatory information using official BIS sources.</p></div>
  </div>
  <div class="disclaimer">BIS AI Assistant — independent prototype, not an official BIS service.</div>
</footer>
<script>
...
async function ask(){
  ...
  try{
    ...
    answer.textContent = "The AI service could not complete this request.";
